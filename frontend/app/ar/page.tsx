...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen pb-24">
      ...
      {/* Hero Section - travle.earth inspired */}
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <section className="py-12">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Link href="/ar/game" className="group block">
            ...
            {/* Quick Quiz Card */}
            <Link href="/ar/quiz" className="group block">
          ...
          <div className="bg-surface rounded-2xl border border-border overflow-hidden">
            ...
            <div className="divide-y divide-border">
              <div className="flex items-center gap-5 p-6">
                ...
                <div>
                  <p className="font-medium text-text-primary">{'اختر التحدي اليومي أو الاختبار السريع'}</p>
                  <p className="text-sm text-text-muted mt-0.5">{'تحديات جديدة كل يوم'}</p>
                </div>
              </div>
              <div className="flex items-center gap-5 p-6">
                <div className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm flex-shrink-0">
                ...
                <div>
                  <p className="font-medium text-text-primary">{'اكتشف الطريق بين الدول'}</p>
                  <p className="text-sm text-text-muted mt-0.5">{'خمّن الدول المتجاورة للوصول إلى الهدف'}</p>
                </div>
              </div>
              <div className="flex items-center gap-5 p-6">
                <div className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm flex-shrink-0">
                ...
                <div>
                  <p className="font-medium text-text-primary">{'شارك نتيجتك وتنافس مع أصدقائك'}</p>
                  <p className="text-sm text-text-muted mt-0.5">{'حافظ على سلسلة انتصاراتك'}</p>
                </div>
              </div>
            </div>
          </div>
